...
<body>
    <div class="container mt-5">
        <h1 class="mb-4">Inventaire de Stock</h1>
        <button class="btn btn-success mb-3" onclick="openAddModal()">Ajouter un produit</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <button type="button" class="btn btn-primary mt-3" onclick="saveChanges()">Enregistrer</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="addProductQuantity">Quantité</label>
